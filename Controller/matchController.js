...
exports.confirmMatch = (req, res) => {
    let allUserMatched = []; //empty array where all matches can be pushed to in order to display them
      ...
      for (i = 0; req.body.like.length > i; i++){ // loop trough all users who liked the user operating the website (user 1)
          ...
          let userMatchedArray = userMatchedValues [11]; // return the values on index 11 which is all the users who liked the other person
...
exports.deleteMatch = (req, res) => {
    ...
    let userMatchedArray = userValues [11];// return the values on index 11 which is all the users who liked the other person
